...
namespace AbpAzureAdLogin.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpAzureAdLoginDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpAzureAdLoginEfCoreEntityExtensionMappings to extend the IdentityUser entity
