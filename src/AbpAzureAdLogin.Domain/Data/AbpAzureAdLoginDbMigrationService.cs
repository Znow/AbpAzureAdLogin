...
{
    public class AbpAzureAdLoginDbMigrationService : ITransientDependency
    {
        public ILogger<AbpAzureAdLoginDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IAbpAzureAdLoginDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public AbpAzureAdLoginDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IAbpAzureAdLoginDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<AbpAzureAdLoginDbMigrationService>.Instance;
        }
